				...
				if (all_result_ori['D'].length) {
					...
					for (let freq_code in all_result_ori) {
						...
						for (let index in all_result_ori[freq_code]) {
							...
							freq_data_now[freq_data_array_name]['data'].push([all_result_ori[freq_code][index].open,
								all_result_ori[freq_code][index].close,
								all_result_ori[freq_code][index].low, all_result_ori[freq_code][index].high
							])
						}
