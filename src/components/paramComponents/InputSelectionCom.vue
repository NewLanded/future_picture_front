<template>
	<div class="block box-align" align="left">
		...
		<el-autocomplete class="inline-input box-border" v-model="inputValue" :fetch-suggestions="querySearch" placeholder="请输入内容"
		 @input="changeInputValue"></el-autocomplete>
	</div>
</template>
